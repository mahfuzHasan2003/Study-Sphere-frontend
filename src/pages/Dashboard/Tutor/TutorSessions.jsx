  ...
  return (
    <div>
      ...
      <p className="text-muted-foreground mb-8">
        View and manage all your scheduled sessions in one place. Keep track of
        upcoming sessions, make updates, and stay organized.
      </p>
        ...
        <Tabs defaultValue="approved" className="">
          ...
          <TabsContent value="approved">
            {approvedTutorSessions?.length > 0 ? (
              <Table>
                <TableCaption>A list of your approved sessions.</TableCaption>
                <TableHeader>
                  <TableRow>
          ...
          <TabsContent value="pending">
            {pendingTutorSessions?.length > 0 ? (
              <Table>
                <TableCaption>A list of your pending sessions.</TableCaption>
                <TableHeader>
                  <TableRow>
                    <TableHead>Session Title</TableHead>
          ...
          <TabsContent value="rejected">
            {rejectedTutorSessions?.length > 0 ? (
              <Table>
                <TableCaption>A list of your rejected sessions.</TableCaption>
                <TableHeader>
                  <TableRow>
                    <TableHead>Session Title</TableHead>
                    <TableHead className="text-right">Action</TableHead>
                      ...
                      <TableCell className="flex justify-end flex-wrap gap-2">
                        {session.requestAttempt < 2 ? (
                          <Popover>
                            ...
                            <PopoverContent>
                              <p className="text-sm">
                                You have a last chance to send a review request
                                for the session again.
                              </p>

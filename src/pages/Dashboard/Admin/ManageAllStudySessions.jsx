      ...
      <TableBody>
        {isPendingLoading || isApprovedLoading ? (
          ...
          <TableRow className="hover:bg-transparent">
            <TableCell colSpan={4} className="text-red-500 text-center pt-10">
        ...
        <DialogContent>
          ...
          <DialogDescription className="grid gap-1">
            ...
            {selectedSession?.rejectionFeedback ? (
              <p>
                <span className="font-bold">Previos Admin Feedback:</span>{" "}
                {selectedSession?.rejectionFeedback}
              </p>
            ) : null}
            <p>
            ...
            <p>
              ...
              {format(
                new Date(selectedSession?.registrationStartDate || null),
                "dd MMM yyyy"
              )}
            </p>
            <p>
            ...
            <p>
              ...
              {convertToHoursAndMinutes(selectedSession?.sessionDuration)}
            </p>
          </DialogDescription>
          <DialogFooter>
            <Button
